...
function footerContainer(): void
{
    ...
    ?>
        ...
        <footer id="footer" class="dark noborder parallax pt-3" style="background-image: url('images/others/section-5.jpg');" data-top-bottom="background-position:100% -300px" data-bottom-top="background-position: 100% 300px">
            <div class="container">
                            ...
                            <div class="row col-mb-30">
                                <div class="col-6 col-lg-4">
                                    <div class="widget">
                                        ...
                                        <h4 class="fw-bold">ЗАПОВЯДАЙТЕ ПРИ НАС</h4>

                                        <ul class="list-unstyled ms-0">
                                            <li class="mb-2"><a class="text-white-50" href="#">+359 78 98 88 71</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">+359 885 83 51 71</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">office@pizzaroyalkn.eu</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">facebook.com/royal.kn</a></li>
                                        </ul>
                                        ул. Власина 2
                                        Кюстендил, България
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="widget">
                                        ...
                                        <h4 class="fw-bold">Полезно</h4>

                                        <ul class="list-unstyled ms-0">
                                            <li class="mb-2"><a class="text-white-50" href="#">Начало</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">Меню</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">Контакти</a></li>
                                            <li class="mb-2"><a class="text-white-50" href="#">Помощ</a></li>
                                        </ul>
                ...
                <div class="container">
                    ...
                    <div class="row col-mb-30">
                        <div class="col-md-6 text-center text-md-start">
                            &copy; Пицария Роял, Кюстендил. Всички права запазени.<br>
                            <div class="copyright-links"><a href="https://balikgstudio.eu">Поддържа се от BalikG Studio.</a></div>
                        </div>
