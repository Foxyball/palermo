...
<title>Galleries | <?php echo SITE_TITLE; ?></title>
                            ...
                            <div class="card">
                                <div class="card-header d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
                                    <div class="d-flex align-items-center gap-3">
                                        <h3 class="card-title mb-0">All Galleries</h3>
                                        <form class="d-flex" method="get" action="gallery_list" role="search">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <?php if ($search !== '') { ?>
                                                    <a class="btn btn-outline-danger" href="gallery_list" title="Clear search">&times;</a>
                                                <?php } ?>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="card-tools ms-md-auto">
                                        <a href="gallery_add" class="btn btn-primary btn-sm">
                                            <i class="bi bi-plus"></i> Add New Gallery
                                        </a>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" class="text-center py-4">
                                                            <div class="text-muted">
                                                                ...
                                                                <p class="mt-2">No galleries found</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php } else { ?>
                                                    <?php foreach ($galleries as $gallery) { ?>
                                                        <tr>
                                                            <td class="align-middle">
                                                                <strong>#<?php echo $gallery['id']; ?></strong>
                                                            </td>
                                                            <td class="align-middle">
                                                            ...
                                                            <td class="align-middle">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input js-gallery-status-toggle" type="checkbox" data-gallery-id="<?php echo $gallery['id']; ?>" <?php echo $gallery['active'] == '1' ? 'checked' : ''; ?>>
                                                                </div>
                                                            </td>
                                                            <td class="align-middle">
                                                            ...
                                                            <td class="align-middle">
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <button type="button" class="btn btn-sm btn-outline-danger js-gallery-delete-btn"
                                                                        data-gallery-id="<?php echo $gallery['id']; ?>"
                                                                        data-gallery-name="<?php echo ($gallery['title']); ?>">
                                                ...
                                                <nav aria-label="Pagination">
                                                    <ul class="pagination pagination-sm mb-0 justify-content-center">
                                                        <li class="page-item <?php echo !$paginator->hasPrev() ? 'disabled' : ''; ?>">
                                                            <a class="page-link" href="<?php echo buildPageUrl(max(1, $paginator->currentPage - 1), 'gallery_list'); ?>" tabindex="-1">&laquo;</a>
                                                        </li>
                                                        <?php foreach ($paginator->pages() as $pg) { ?>
                                                            <li class="page-item <?php echo ($pg === $paginator->currentPage) ? 'active' : ''; ?>">
                                                                <a class="page-link" href="<?php echo buildPageUrl($pg, 'gallery_list'); ?>"><?php echo $pg; ?></a>
                                                            </li>
                                                        <?php } ?>
                                                        <li class="page-item <?php echo !$paginator->hasNext() ? 'disabled' : ''; ?>">
                                                            <a class="page-link" href="<?php echo buildPageUrl(min($paginator->totalPages, $paginator->currentPage + 1), 'gallery_list'); ?>">&raquo;</a>
                                                        </li>
                                                    </ul>
                                                </nav>
                                            </div>
        ...
        $(function() {
            ...
            $(document).on('click', '.js-gallery-delete-btn', async function(e) {
                ...
                const confirmed = await Swal.fire({
                    ...
                    html: `<p class="mb-1">You are about to delete <strong>${$('<div>').text(galleryTitle).html()}</strong>.</p><small class="text-danger">This action cannot be undone.</small>`,
                    icon: 'warning',
