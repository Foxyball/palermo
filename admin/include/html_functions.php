            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="user-image rounded-circle shadow border border-2 border-primary"
                                  style="width:40px;height:40px;display:inline-flex;align-items:center;justify-content:center;font-size:1.25rem;background:#f8f9fa;color:#003b79;">
                ...
                <ul
                    ...
                    <li class="nav-item <?php echo $isAdminSection ? 'menu-open' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="admin_list"
                                   class="nav-link <?php echo in_array($currentPage, ['admin_list', 'admin_add', 'admin_edit']) ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item <?php echo $isArticleSection || $isAddonsSection || $isProductSection ? 'menu-open' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="category_list"
                                   class="nav-link <?php echo in_array($currentPage, ['category_list', 'category_add', 'category_edit']) ? 'active' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="addons_list"
                                   class="nav-link <?php echo in_array($currentPage, ['addons_list', 'addons_add', 'addons_edit']) ? 'active' : ''; ?>">
                                    <i class="bi bi-node-plus-fill nav-icon"></i>
                                    <p>Addons</p>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="order_status_list"
                                   class="nav-link <?php echo in_array($currentPage, ['order_status_list', 'order_status_add', 'order_status_edit']) ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item <?php echo $isGallerySection ? 'menu-open' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="gallery_list"
                                   class="nav-link <?php echo in_array($currentPage, ['gallery_list', 'gallery_add', 'gallery_edit', 'gallery_images']) ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item <?php echo $isBlogSection || $isBlogCategorySection ? 'menu-open' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="blog_list"
                                   class="nav-link <?php echo in_array($currentPage, ['blog_list', 'blog_add', 'blog_edit']) ? 'active' : ''; ?>">
                                    <i class="bi bi-newspaper nav-icon"></i>
                                    <p>Blog Post</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="blog_category_list"
                                   class="nav-link <?php echo in_array($currentPage, ['blog_category_list', 'blog_category_add', 'blog_category_edit']) ? 'active' : ''; ?>">
                                    <i class="bi bi-tag-fill nav-icon"></i>
                                    <p>Blog Category</p>
                                </a>
                            </li>
