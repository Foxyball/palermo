...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $errors[] = 'There was an error creating the order status. Please try again.';
        }
    }
}
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0"><?php echo SITE_TITLE; ?> | Add New Order Status</h3>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" novalidate>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" value="<?php echo htmlspecialchars($_POST['name'] ?? ''); ?>" required placeholder="e.g. Ready for Pickup">
                                        </div>
