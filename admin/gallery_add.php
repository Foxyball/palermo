...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $errors[] = 'There was an error creating the gallery. Please try again.';
        }
    }
}
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0"><?php echo SITE_TITLE; ?> | Add New Gallery</h3>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" novalidate>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($_POST['title'] ?? ''); ?>" required placeholder="e.g. Summer Vacation 2024">
                                        </div>
