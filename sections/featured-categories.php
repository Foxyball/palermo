				...
				<div class="row align-items-stretch">
					...
					<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #1B1B1B;">
						...
						<div class="cat-text">
							...
							<a href="<?php echo BASE_URL; ?>cat/snacks" data-scrollto="#menu-snacks" data-easing="easeInOutExpo" data-speed="1250" class="button button-rounded px-4 button-border button-light button-white fw-semibold ms-0">View All</a>
						</div>
					</div>
					...
					<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #262626;">
						...
						<div class="cat-text">
							...
							<a href="<?php echo BASE_URL; ?>cat/beverages" data-scrollto="#menu-beverages" data-easing="easeInOutExpo" data-speed="1250" class="button button-rounded px-4 button-border button-light button-white fw-semibold ms-0">View All</a>
						</div>
					</div>
