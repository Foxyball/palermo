				...
				<div class="row align-items-stretch">
					...
					<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #0A0A0A;">
						...
						<div class="cat-text">
							...
							<a href="<?php echo BASE_URL; ?>cat/burgers" data-scrollto="#menu" data-easing="easeInOutExpo" data-speed="1250" class="button button-rounded px-4 button-border button-light button-white fw-semibold ms-0">View All</a>
						</div>
					</div>
					...
					<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #1B1B1B;">
						...
						<div class="cat-text">
							<h2 class="fw-bold ls-1 text-uppercase mb-5">Pizza</h2>
							...
							<a href="<?php echo BASE_URL; ?>cat/pizza" data-scrollto="#menu-snacks" data-easing="easeInOutExpo" data-speed="1250" class="button button-rounded px-4 button-border button-light button-white fw-semibold ms-0">View All</a>
						</div>
					</div>
					...
					<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #262626;">
						...
						<div class="cat-text">
							<h2 class="fw-bold ls-1 text-uppercase mb-5">Pasta</h2>
							...
							<a href="<?php echo BASE_URL; ?>cat/pasta" data-scrollto="#menu-beverages" data-easing="easeInOutExpo" data-speed="1250" class="button button-rounded px-4 button-border button-light button-white fw-semibold ms-0">View All</a>
						</div>
					</div>
